...
export default [
    ...
    {name:'河北', cityList:[		   
        ...
        {name:'邢台市', areaList:['桥东区','桥西区','邢台县','临城县','内丘县','柏乡县','隆尧县','任　县','南和县','宁晋县','巨鹿县','新河县','广宗县','平乡县','威县','清河县','临西县','南宫市','沙河市']},		   
        {name:'保定市', areaList:['新市区','北市区','南市区','满城县','清苑县','涞水县','阜平县','徐水县','定兴县','唐　县','高阳县','容城县','涞源县','望都县','安新县','易县','曲阳县','蠡县','顺平县','博野县','雄县','涿州市','定州市','安国市','高碑店市']},		   
        ...
        {name:'沧州市', areaList:['新华区','运河区','沧　县','青县','东光县','海兴县','盐山县','肃宁县','南皮县','吴桥县','献县','孟村回族自治县','泊头市','任丘市','黄骅市','河间市']},		   
    ...
    {name:'山西', cityList:[		   
        ...
        {name:'运城市', areaList:['盐湖区','临猗县','万荣县','闻喜县','稷山县','新绛县','绛　县','垣曲县','夏县','平陆县','芮城县','永济市','河津市']},		   
    ...
    {name:'浙江', cityList:[		   
        {name:'杭州市', areaList:['上城区','下城区','江干区','拱墅区','西湖区','滨江区','萧山区','余杭区','桐庐县','淳安县','建德市','富阳区','临安市']},		   
        ...
        {name:'绍兴市', areaList:['越城区','柯桥区','新昌县','诸暨市','上虞区','嵊州市']},		   
    ...
    {name:'河南', cityList:[		   
        ...
        {name:'信阳市', areaList:['师河区','平桥区','罗山县','光山县','新　县','商城县','固始县','潢川县','淮滨县','息县']},		   
    ...
    {name:'四川', cityList:[		   
        ...
        {name:'达州市', areaList:['通川区','达　县','宣汉县','开江县','大竹县','渠县','万源市']},		   
    ...
    {name:'台湾', cityList:[		   
        {areaList:['台北市','高雄市','基隆市','台中市','台南市','新竹市','嘉义市','宜兰县','桃园县','新竹县','苗栗县','彰化县','南投县','云林县','嘉义县','花莲县']}   
    ]},
    {name:'香港', cityList:[		   
        {areaList:['中西区','东区',' 九龙城区',' 观塘区','南区','深水埗区','黄大仙区','湾仔区','油尖旺区','离岛区',' 葵青区','北区','西贡区','沙田区','屯门区','大埔区','荃湾区',' 元朗区']}   
    ]},
    {name:'澳门', cityList:[		   
        {areaList:['澳门特别行政区']}   
    ]},
